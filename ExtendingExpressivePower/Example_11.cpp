/* Passing by value and passing by reference
 ...
 Use the “passing by value” if you don't need to share the function's results 
 using the parameter's values, and use “passing by reference” in all other cases.
*/
#include <iostream>
